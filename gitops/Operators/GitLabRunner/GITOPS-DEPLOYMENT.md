...
GitLab URL: https://gitlab.apps.mays-demo.sandbox1374.opentlc.com
...
1. Login to GitLab: `https://gitlab.apps.mays-demo.sandbox1374.opentlc.com`
...
oc run test-curl -n gitlab-runner-system --image=curlimages/curl --rm -it --restart=Never -- \
  curl -v https://gitlab.apps.mays-demo.sandbox1374.opentlc.com/-/readiness
```
